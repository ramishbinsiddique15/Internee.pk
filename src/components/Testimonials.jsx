...
const Testimonials = () => {
  ...
  const slideContent = [
    ...
    {
      text: "\" internee.pk is all about helping us grow our careers. May ALLAH give them more achievements and success on their journey. \"",
      name: "Nagina Asif",
      location: "Karachi, Pakistan",
    },
    {
    ...
    {
      text: "\" I find internee.pk to be an outstanding tool for getting hands-on experience. Sometimes you have to spend a little to make a lot to develop projects. \"",
      name: "Kashan Soomro",
      location: "Multan, Pakistan",
    },
    {
      text: " \"Amazing! internee.pk is a game changer! The way their team is working is so crazy. Thank you for giving me this opportunity. \"",
      name: "Naila Rozi",
      location: "Lahore, Pakistan",
    },
    {
      text: " \" After getting this internship, my skills got enhanced more than my expectations. JazakALLAH for this. \"",
      name: "Muhammad Rafiq",
    ...
    {
      text: " \" Been using internee.pk for internship is an amazing experience. I do some other virtual internships as well but their task portal and presentation are amazing \"",
      name: "Sidra",
