...
const Portal = () => {
  ...
  const options = [
    ...
    },
    {
      ...
      description: "Teamwork is at the heart of our philosophy. Our platform fosters collaborative learning, enabling interns to work together on group projects. You'll gain not only technical skills but also the ability to thrive in a team environment."
    },
    {
