...
<path d="M15.5 14L20.5 19L19 20.5L14 15.5V14.71L13.73 14.43C12.59 15.41 11.11 16 9.5 16C7.77609 16 6.12279 15.3152 4.90381 14.0962C3.68482 12.8772 3 11.2239 3 9.5C3 7.77609 3.68482 6.12279 4.90381 4.90381C6.12279 3.68482 7.77609 3 9.5 3C11.2239 3 12.8772 3.68482 14.0962 4.90381C15.3152 6.12279 16 7.77609 16 9.5C16 11.11 15.41 12.59 14.43 13.73L14.71 14H15.5ZM9.5 14C12 14 14 12 14 9.5C14 7 12 5 9.5 5C7 5 5 7 5 9.5C5 12 7 14 9.5 14ZM12 10H10V12H9V10H7V9H9V7H10V9H12V10Z" fill="#43a724"/>
            ...
            <div className="option-txt">
              <p>
                <b>Certification</b> Complete courses on our LMS and earn certifications that validate your expertise. Showcase your accomplishments to potential employers and stand out in a competitive landscape.
              </p>
            </div>
          </div>
          <div className="option">
...
<path d="M11 9H13V7H11V9ZM12 20C7.59 20 4 16.41 4 12C4 7.59 7.59 4 12 4C16.41 4 20 7.59 20 12C20 16.41 16.41 20 12 20ZM12 2C10.6868 2 9.38642 2.25866 8.17317 2.7612C6.95991 3.26375 5.85752 4.00035 4.92893 4.92893C3.05357 6.8043 2 9.34784 2 12C2 14.6522 3.05357 17.1957 4.92893 19.0711C5.85752 19.9997 6.95991 20.7362 8.17317 21.2388C9.38642 21.7413 10.6868 22 12 22C14.6522 22 17.1957 20.9464 19.0711 19.0711C20.9464 17.1957 22 14.6522 22 12C22 10.6868 21.7413 9.38642 21.2388 8.17317C20.7362 6.95991 19.9997 5.85752 19.0711 4.92893C18.1425 4.00035 17.0401 3.26375 15.8268 2.7612C14.6136 2.25866 13.3132 2 12 2V2ZM11 17H13V11H11V17Z" fill="#43a724"/>
            ...
            <div className="option-txt">
              <p>
                <b>Courses in Urdu</b> Understanding the Software Development Life Cycle (SDLC) is pivotal in the tech world. Acquire skills that align with industry standards and boost your project management proficiency.
              </p>
            </div>
          </div>
          <div className="option">
...
<path d="M22.5625 4.01453C23.0929 4.01453 23.6016 4.22524 23.9767 4.60031C24.3518 4.97539 24.5625 5.48409 24.5625 6.01453V16.0145C24.5625 16.545 24.3518 17.0537 23.9767 17.4287C23.6016 17.8038 23.0929 18.0145 22.5625 18.0145H6.5625C6.03207 18.0145 5.52336 17.8038 5.14829 17.4287C4.77321 17.0537 4.5625 16.545 4.5625 16.0145V4.01453C4.5625 3.48409 4.77321 2.97539 5.14829 2.60031C5.52336 2.22524 6.03207 2.01453 6.5625 2.01453H12.5625L14.5625 4.01453H22.5625ZM2.5625 6.01453V20.0145H20.5625V22.0145H2.5625C2.03207 22.0145 1.52336 21.8038 1.14829 21.4287C0.773214 21.0537 0.5625 20.545 0.5625 20.0145V11.0145V6.01453H2.5625ZM6.5625 6.01453V16.0145H22.5625V6.01453H6.5625Z" fill="#43a724"/>
</g>
<defs>
<clipPath id="clip0">
<rect width="24" height="24" fill="white" transform="translate(0.5625 0.0145264)"/>
</clipPath>
</defs>
</svg>
            ...
            <div className="option-txt">
              <p>
                <b>Practice Exercises</b> Theory is just the beginning. Our LMS goes beyond by offering practical exercises that challenge and refine your skills. Apply your knowledge in real-world scenarios, solidifying your understanding and boosting your confidence
              </p>
            </div>
          </div>
        </div>
