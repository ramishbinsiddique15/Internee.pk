...
useEffect(() => {
  ...
  const options = [
    ...
    {
      iconPath: "M11 14V22H3V14H11ZM9 16H5V20H9V16ZM12 2.5L17.5 11.5H6.5L12 2.5ZM12 6.36L10.08 9.5H13.92L12 6.36ZM17.5 13.5C20 13.5 22 15.5 22 18C22 20.5 20 22.5 17.5 22.5C15 22.5 13 20.5 13 18C13 15.5 15 13.5 17.5 13.5ZM17.5 15.5C16.837 15.5 16.2011 15.7634 15.7322 16.2322C15.2634 16.7011 15 17.337 15 18C15 18.663 15.2634 19.2989 15.7322 19.7678C16.2011 20.2366 16.837 20.5 17.5 20.5C18.163 20.5 18.7989 20.2366 19.2678 19.7678C19.7366 19.2989 20 18.663 20 18C20 17.337 19.7366 16.7011 19.2678 16.2322C18.7989 15.7634 18.163 15.5 17.5 15.5Z",
      title: "Generate Revenue",
      description: "Teach what you love and earn what you deserve. Internee.pk LMS offers instructors the opportunity to generate revenue. Monetize your expertise, reach a global audience, and make a meaningful income from your passion"
    },
    {
      iconPath: "M5 20H19V18H5V20ZM19 9H15V3H9V9H5L12 16L19 9Z",
    ...
    {
      iconPath: "M14 10H2V12H14V10ZM14 6H2V8H14V6ZM2 16H10V14H2V16ZM21.5 11.5L23 13L16 20L11.5 15.5L13 14L16 17L21.5 11.5Z",
  ...
  return (
    <div className="Portal">
      <div data-aos = "fade-right" className="instructor-img">
